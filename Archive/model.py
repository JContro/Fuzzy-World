...
copy_X_test['Pred'] = classified.predict(copy_X_test[feature_columns])
copy_X_test.sort_values('Pred', inplace=True)
copy_X_test.to_csv("test.csv")
print(classified.predict(copy_X_test[feature_columns]))
